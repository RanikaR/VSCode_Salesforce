...
// An empty lits of records to verify the component does something reasonable
...
describe('c-wire-apex', () => {
    ...
    describe('getAccountLst @wire data', () => {
        it('renders six records', ()=> {
            ...
            return Promise.resolve().then(() => {
                ...
                expect(accountElements.length).toBe(mockGetAccountList.legnth);
